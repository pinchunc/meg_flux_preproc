...
#scalp_chan_list = ['F5', 'F6', 'C5', 'C6', 'P5', 'P6']
this_scalp_chan = 'Cz'

#%% load sleep events timing
# megeeg_slythms_nrem_Cz.mat
# the events here were in 500Hz
import scipy.io
...
deriv_fname_spindles = deriv_fname_spindles.replace('Cz',this_scalp_chan)
...
for run_idx in range(len(task_files)):
    ...
    if not (2 in stage_data or 3 in stage_data):
        ...
        file_name = f's{subject}_{task}_r{run}_slythm_NREM_{this_scalp_chan}'
